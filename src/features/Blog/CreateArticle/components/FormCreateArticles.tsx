...
export default function FormCreateArticles() {
    ...
    const { executeAsync, hasErrored, result, hasSucceeded } = useAction(ArticlesSafeAction, {
        onSuccess: (data) => {
        ...
        onError: (error) => {
            ...
            toast.error(error.error.serverError || "Une erreur est survenue lors de la création de l'article");
        }
    });
