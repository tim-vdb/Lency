...
export default function Newsletter({ title = 'Restez informés', description = 'Inscrivez-vous à notre newsletter pour recevoir les dernières nouvelles et annonces.' }: NewsletterProps) {
    ...
    const { executeAsync, hasErrored, result, hasSucceeded } = useAction(NewsletterSafeAction, {
        onSuccess: (data) => {
