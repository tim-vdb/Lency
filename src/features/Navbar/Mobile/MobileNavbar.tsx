...
export default function MobileNavbar({ setIsScrolled, menuOpen, setMenuOpen }: MobileNavbarProps) {
    ...
    const linksClasses = {
        ...
        notActive: "text-neutral-900 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-neutral-700"
    }
        ...
        <nav className="md:hidden absolute top-full left-0 right-0 bg-white dark:bg-neutral-900 shadow-lg font-cooper">
            <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
                ...
                <Link
                    href="/events"
                    onClick={() => setMenuOpen(false)}
                    className={cn(linksClasses.base, isActive("/events")
                        ? linksClasses.isActive
                        : linksClasses.notActive
                    )}
                >
                ...
                <Link
                    href="/contact"
                    onClick={() => setMenuOpen(false)}
                    className={cn(linksClasses.base, isActive("/contact")
                        ? linksClasses.isActive
                        : linksClasses.notActive
                    )}
                >
                ...
                <Link
                    href="/about"
                    onClick={() => setMenuOpen(false)}
                    className={cn(linksClasses.base, isActive("/about")
                        ? linksClasses.isActive
                        : linksClasses.notActive
                    )}
                >
