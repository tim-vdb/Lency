  ...
  return (
    <section className="w-full py-20 px-8 lg:px-16 bg-[#FAF7F2]">
      <div className="max-w-7xl mx-auto">
        <div className="bg-white rounded-3xl flex flex-col items-center text-center gap-6 py-16 px-8 sm:px-16 lg:px-24 border border-neutral-100">
          <h2 className="text-[30px] font-black text-neutral-900 leading-tight">
            Choisis ton profil pour apprendre, collaborer et progresser.
          </h2>
          <p className="text-[16px] text-neutral-500 leading-relaxed max-w-xl">
