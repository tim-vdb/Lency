...
export default function ConfirmEmailChangeContent() {
    ...
    async function handleConfirm() {
        ...
        try {
            ...
            setStatus('success');
            setTimeout(() => router.push('/account/settings/profile'), 2000);
        } catch {
    ...
    if (!token) {
        return (
            <div className="text-center">
                ...
                <Button className="mt-6" onClick={() => router.push('/account/settings/profile')}>
                    Retour au profil
                </Button>
            </div>
        );
    ...
    if (status === 'success') {
        return (
            <div className="text-center">
                ...
                <h2 className="text-2xl font-semibold mb-2">Email confirmé !</h2>
                <p className="text-muted-foreground">Votre adresse email a été mise à jour avec succès. Redirection en cours...</p>
            </div>
        );
    }
    ...
    return (
        <div className="text-center">
            <h2 className="text-2xl font-semibold mb-2">Confirmer le changement d'email</h2>
            <p className="text-muted-foreground mb-6">
                Cliquez sur le bouton ci-dessous pour valider votre nouvelle adresse email.
            </p>
