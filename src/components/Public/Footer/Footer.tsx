...
import FooterNavbar from '@/components/Navbar/Public/Desktop/FooterNavbar';
import Newsletter from '@/components/Public/Footer/components/Newsletter';
import SocialMedia from '@/components/Public/Footer/components/SocialMedia';
