      ...
      <Card className="pt-0">
        <CardHeader className="flex items-center gap-2 space-y-0 border-b py-5 sm:flex-row">
          <div className="grid flex-1 gap-1">
            ...
            <CardDescription>
              Utilisateurs, projets, posts, ressources et emails créés par jour
            </CardDescription>
          </div>
        </CardHeader>
    ...
    <Card className="pt-0">
      <CardHeader className="flex items-center gap-2 space-y-0 border-b py-5 sm:flex-row">
        <div className="grid flex-1 gap-1">
          <CardTitle>Activité quotidienne</CardTitle>
          <CardDescription>
            Créations par jour sur les 90 derniers jours
          </CardDescription>
        </div>
          ...
          >
            <defs>
              <linearGradient id="fillUsers" x1="0" y1="0" x2="0" y2="1">
                <stop offset="5%" stopColor={DASHBOARD_COLORS.users.hex} stopOpacity={0.8} />
                <stop offset="95%" stopColor={DASHBOARD_COLORS.users.hex} stopOpacity={0.1} />
              </linearGradient>
              <linearGradient id="fillProjects" x1="0" y1="0" x2="0" y2="1">
                <stop offset="5%" stopColor={DASHBOARD_COLORS.projects.hex} stopOpacity={0.8} />
                <stop offset="95%" stopColor={DASHBOARD_COLORS.projects.hex} stopOpacity={0.1} />
              </linearGradient>
              <linearGradient id="fillPosts" x1="0" y1="0" x2="0" y2="1">
                <stop offset="5%" stopColor={DASHBOARD_COLORS.posts.hex} stopOpacity={0.8} />
                <stop offset="95%" stopColor={DASHBOARD_COLORS.posts.hex} stopOpacity={0.1} />
              </linearGradient>
              <linearGradient id="fillResources" x1="0" y1="0" x2="0" y2="1">
                <stop offset="5%" stopColor={DASHBOARD_COLORS.resources.hex} stopOpacity={0.8} />
                <stop offset="95%" stopColor={DASHBOARD_COLORS.resources.hex} stopOpacity={0.1} />
              </linearGradient>
              <linearGradient id="fillEmails" x1="0" y1="0" x2="0" y2="1">
                <stop offset="5%" stopColor={DASHBOARD_COLORS.emails.hex} stopOpacity={0.8} />
                <stop offset="95%" stopColor={DASHBOARD_COLORS.emails.hex} stopOpacity={0.1} />
              </linearGradient>
            </defs>
