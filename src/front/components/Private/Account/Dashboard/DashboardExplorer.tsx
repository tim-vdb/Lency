        ...
        <div className="flex flex-col gap-3 flex-1 min-h-0 overflow-y-auto">
            ...
            <div className="shrink-0">
                <button
                    ...
                    className="flex items-center gap-2 text-sm font-medium text-[#4C4A43] dark:text-neutral-300 hover:text-black dark:hover:text-white transition-colors cursor-pointer"
                >
            ...
            {/* Map */}
            <Card className="border border-[#E8E8E1] dark:border-neutral-700 dark:bg-neutral-900 overflow-hidden py-0 shrink-0 w-full rounded-xl" style={{ height: "clamp(220px, 30.6vh, 330px)" }}>
            ...
            <div className="shrink-0">
                {mode === "projets" ? (
                    filteredProjects.length === 0 ? (
                        <p className="text-sm text-[#8C8A85] dark:text-neutral-400 text-center py-6">Aucun projet trouvé</p>
                    ) : (
                    ...
                    filteredTalents.length === 0 ? (
                        <p className="text-sm text-[#8C8A85] dark:text-neutral-400 text-center py-6">Aucun talent trouvé</p>
                    ) : (
                        <div className="grid grid-cols-2 gap-3 pb-2">
