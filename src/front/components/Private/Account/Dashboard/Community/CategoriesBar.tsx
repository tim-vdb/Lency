...
export default function CategoriesBar() {
    ...
    return (
        <div className="relative w-full px-2">
            {/* Shadow gauche */}
            <div className="absolute left-2 top-0 bottom-0 w-8 bg-linear-to-r from-white via-white/10 to-transparent z-10 pointer-events-none" />

            {/* Shadow droite */}
            <div className="absolute right-2 top-0 bottom-0 w-8 bg-linear-to-l from-white via-white/10 to-transparent z-10 pointer-events-none" />
