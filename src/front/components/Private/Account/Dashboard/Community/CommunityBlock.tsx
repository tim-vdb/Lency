...
export default function CommunityBlock() {
    ...
    return (
        <Card className="justify-between col-span-5 p-3 2xl:gap-10 2xl:p-6">
            <CardHeader className="flex items-center flex-col px-0">
                <div className="flex items-center justify-between w-full">
                    <div className="flex flex-col">
                        <CardTitle className='flex flex-wrap text-xl 2xl:text-2xl'>La Communauté</CardTitle>
                    ...
                    <div className="flex items-center gap-4">
                        <Button variant={"outline"} className="ml-auto text-xs 2xl:text-base p-1! px-1.5! 2xl:py-2 2xl:px-3 shadow-lg-base cursor-pointer border-neutral-300">
                            <span>New Post</span>
