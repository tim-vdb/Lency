...
//               className='opacity-0 absolute top-0 right-0 transition-opacity duration-500 delay-300 group-hover:multi-["opacity-100;duration-200;delay-0;animate-slide-in-right"]'
//             >
...
//               className='absolute top-0 left-0 transition-opacity duration-500 delay-300 group-hover:multi-["opacity-100;duration-200;delay-0"]'
//             >
//               {blog.published ? (
...
//         <div>
//           <CardTitle className="mb-5 text-xl font-bold truncate">
//             {blog.title}
//           </CardTitle>
...
//             <Button
//               variant="default"
//               className="w-full cursor-pointer hover:animate-[squeeze_0.6s_ease-in-out_infinite]"
//             >
