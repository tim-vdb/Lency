...
export default function MarketplaceBlock() {
    return (
        <Card className="col-[1/5] row-[5/9] justify-between gap-0 border border-neutral-400">
            <CardHeader className="px-4">
                <CardTitle>Nos marketplaces</CardTitle>
                <CardDescription>Connectez-vous aux projets et aux créateurs</CardDescription>
            </CardHeader>
            <CardContent className="grid grid-cols-2 gap-5 px-4">
                        ...
                        <CardContent className="flex flex-col gap-4 px-0">
                            {section.items.map((item, itemIndex) => (
                                <Card key={itemIndex} className="py-3 gap-2 border border-neutral-400 shadow-lg-base">
                                    ...
                                    <CardContent className="line-clamp-2 text-xs">
                                        {item.description}
                                    </CardContent>
