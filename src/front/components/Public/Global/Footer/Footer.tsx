...
const LINK_CLASS = "text-[20px] text-[#000000] hover:text-[#EA3D0E] transition-colors";
...
export default function Footer() {
  ...
  return (
    <footer className={cn('bg-white py-12', isAdmin ? 'px-4' : 'md:px-20 lg:px-20 xl:px-20')}>
      <div className="container grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
        ...
        <div className="flex flex-col items-center gap-3 text-center">
          ...
          <p className="text-sm text-[#4C4A43] max-w-[220px]">
            Communauté audiovisuelle pour apprendre, collaborer et progresser.
          </p>
          <div className="w-full border-t border-[#E8E8E1] mt-1" />
        </div>
      </div>
    </footer>
  );
