...
export const useCreateProject = () => {
    ...
    return useMutation({
        ...
        onSuccess: () =>
            queryClient.invalidateQueries({ queryKey: [...PROJECT_ROOT, "list"] }),
    })
}
...
export const useUpdateProject = () => {
    ...
    return useMutation({
        ...
        onSuccess: (_data, { id }) => {
            // Invalide la liste ET le détail du projet modifié
            queryClient.invalidateQueries({ queryKey: [...PROJECT_ROOT, "list"] })
            queryClient.invalidateQueries({ queryKey: [...PROJECT_ROOT, "detail", id] })
        },
    })
}
