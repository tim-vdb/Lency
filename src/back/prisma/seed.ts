...
async function main() {
    ...
    await prisma.post.create({
        data: {
            title: "Les tendances design 2026",
    ...
    await prisma.post.create({
        data: {
            title: "Next.js 15 + Prisma 7 : retour d'expérience",
    ...
    await prisma.post.create({
        data: {
            title: "Besoin de feedback sur mon portfolio",
    ...
    await prisma.post.create({
        data: {
            title: "Mes réflexions sur l'accessibilité web",
    ...
    await prisma.post.create({
        data: {
            title: "Podcast : retour sur la conf Design System Paris",
    ...
    await prisma.post.create({
        data: {
            title: "Ma première semaine sur Lency",
    ...
    await prisma.post.create({
        data: {
            title: "Retour d'expérience : passer au premium",
    ...
    await prisma.post.create({
        data: {
            title: "Deep dive audio : les bases de l'animation CSS",
